<script setup lang = "ts">
    import {ref} from "vue";
    import carouselImage1 from "../assets/How-They-Control_Us.png"
    import carouselImage2 from "../assets/50-Years.png"
    import carouselImage3 from "../assets/Breaking-Modern-Education.png"
    import carouselImage4 from "../assets/Dharma-Raksha.png"
    import carouselImage5 from "../assets/Ek-Ekad-Jamin.png"
    import carouselImage6 from "../assets/Ram.png"
    import carouselImage7 from "../assets/Adipurush.png"
    ...
    <section class="p-20">
      <div id="default-carousel" class="relative grid" data-carousel="slide">
        ...
        <div class="relative flex justify-self-center overflow-hidden rounded-lg h-128 w-3/5">
          <!-- Items -->
          <div v-for="(image, index) in images" :key="index" class="duration-700 ease-in-out absolute inset-0 transition-opacity"
        ...
        <div class="absolute z-30 flex -translate-x-1/2 -bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
          <button v-for="(_, index) in images" :key="index" type="button" class="w-3 h-3 bg-white rounded-full"
                  ...
                  :class="{'bg-white': currentSlide === index, 'bg-gray-400': currentSlide !== index }"></button>
        </div>
